        ...
        deepseekConfig !== null && (
            ...
            >
                ...
                <div className='config-item'>
                    ...
                    >
                        {t('services.translate.deepseek_cloud.stream')}
                    </Switch>
                </div>
                <div className='config-item'>
                    <h3 className='my-auto'>{t('services.translate.deepseek_cloud.model')}</h3>
                    <Dropdown>
                        <DropdownTrigger>
                            <Button variant='bordered'>{deepseekConfig.model}</Button>
                        </DropdownTrigger>
                        <DropdownMenu
                            autoFocus='first'
                            aria-label='model'
                ...
                <p className='text-[10px] text-default-700'>
                    {t('services.translate.deepseek_cloud.prompt_description')}
                </p>

                <div className='bg-content2 rounded-[10px] p-3'>
                    {deepseekConfig.promptList &&
                        deepseekConfig.promptList.map((prompt, index) => {
                            return (
                                <div className='config-item'>
                                    <Textarea
                                        label={prompt.role}
                        ...
                        onPress={() => {
                            setServiceConfig({
                                ...
                                promptList: [
                                    ...
                                    {
                                        role:
                                            deepseekConfig.promptList.length === 0
                                                ? 'system'
                                                : deepseekConfig.promptList.length % 2 === 0
                                                  ? 'assistant'
                                                  : 'user',
                                        content: '',
                                    },
                    ...
                    >
                        {t('services.translate.deepseek_cloud.add')}
                    </Button>
                </div>
                <br />
