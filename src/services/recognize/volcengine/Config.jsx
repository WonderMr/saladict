...
export function Config(props) {
    ...
    const [config, setConfig] = useConfig(
        instanceKey,
        {
            [INSTANCE_NAME_CONFIG_KEY]: t('services.recognize.volcengine_ocr.title'),
            appid: '',
            secret: '',
        },
        { sync: false }
    ...
    return (
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.volcengine_ocr.appid')}
                        labelPlacement='outside-left'
                        value={config['appid']}
                        variant='bordered'
                        classNames={{
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.volcengine_ocr.secret')}
                        labelPlacement='outside-left'
                        value={config['secret']}
                        variant='bordered'
                        classNames={{
