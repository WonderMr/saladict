...
export function Config(props) {
    ...
    const [config, setConfig] = useConfig(
        instanceKey,
        {
            [INSTANCE_NAME_CONFIG_KEY]: t('services.recognize.iflytek_intsig_ocr.title'),
            appid: '',
            apisecret: '',
            apikey: '',
        },
        ...
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    ...
                    <Button
                        onPress={() => {
                            open('https://app.saladict.net/docs/api/recognize/iflytek.html');
                        }}
                    >
                        {t('services.help')}
                    </Button>
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.iflytek_intsig_ocr.appid')}
                        labelPlacement='outside-left'
                        value={config['appid']}
                        variant='bordered'
                        classNames={{
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.iflytek_intsig_ocr.apisecret')}
                        labelPlacement='outside-left'
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.iflytek_intsig_ocr.apikey')}
                        labelPlacement='outside-left'
                        value={config['apikey']}
                        variant='bordered'
                        classNames={{
