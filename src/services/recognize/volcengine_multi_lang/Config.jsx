...
export function Config(props) {
    ...
    const [config, setConfig] = useConfig(
        instanceKey,
        {
            [INSTANCE_NAME_CONFIG_KEY]: t('services.recognize.volcengine_multi_lang_ocr.title'),
            appid: '',
            secret: '',
        },
        { sync: false }
        ...
        config !== null && (
            ...
            >
                ...
                <div className={'config-item'}>
                    ...
                    <Button
                        onPress={() => {
                            open('https://app.saladict.net/docs/api/recognize/volcengine.html');
                        }}
                    >
                        {t('services.help')}
                    </Button>
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.volcengine_multi_lang_ocr.appid')}
                        labelPlacement='outside-left'
                        value={config['appid']}
                        variant='bordered'
                        classNames={{
                ...
                <div className={'config-item'}>
                    <Input
                        label={t('services.recognize.volcengine_multi_lang_ocr.secret')}
                        labelPlacement='outside-left'
                        value={config['secret']}
                        variant='bordered'
                        classNames={{
